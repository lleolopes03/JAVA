 ...
 * @author USER
 */
public class view_detalhe_venda extends javax.swing.JFrame {

    /**
     * Creates new form view_detalhe_venda
     */
    public view_detalhe_venda() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tbdetalhe = new javax.swing.JTable();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("DETALHE VENDA"));
        ...
        tbdetalhe.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "CÓDIGO", "PRODUTO", "QTD_COMPRADA", "VALOR", "SUBTOTAL"
            }
        ) {
        ...
        jScrollPane2.setViewportView(tbdetalhe);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_detalhe_venda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new view_detalhe_venda().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable tbdetalhe;
